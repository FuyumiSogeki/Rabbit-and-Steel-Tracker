...
Tracker:AddLocations("locations/geode.jsonc")
Tracker:AddLocations("locations/darkhouseDepths.jsonc")
Tracker:AddLocations("locations/atelierAurum.jsonc")
Tracker:AddLocations("locations/subterraSanctum.jsonc")
Tracker:AddLocations("locations/loopingHallway.jsonc")
Tracker:AddLocations("locations/reflectingPool.jsonc")
Tracker:AddLocations("locations/class.jsonc")
Tracker:AddLocations("locations/kingdom.jsonc")
Tracker:AddLocations("locations/extra.jsonc")
